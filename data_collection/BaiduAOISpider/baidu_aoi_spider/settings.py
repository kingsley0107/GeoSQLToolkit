...
# File path settings
POI_CSV_PATH = "data/university.csv"
AOI_SHP_PATH = "data/AOI/AOI.shp"

# Spider settings
PROXY_ENABLED = False
UPDATE_INTERVAL = 150.0  # how many AOI API calls before updating the output file
USE_FIRST_UID = False
...
AK_LIST = [
    "DtE9DWaBs56Yxg4pZv8fCGwKG3oNXY5W",
]
...
FILTER_RULES = {
    ...
    "min_aoi_area": 0.0,  # Set to 0 to disable
    "max_aoi_area": 10000.0,  # Set to a large number to disable, e.g. 10000
    # 2. Lowest name similarity between AOI and POI
    "min_similarity": 0.2,  # 0 to disable, maximum is 1
